...
export default class OutputScript extends Script {
  ...
  get type() {
    for (const [Class, typeString] of [
      [PublicKeyOutputScript, types.PUBKEY],
      [PublicKeyHashOutputScript, types.PUBKEYHASH],
      [ScriptHashOutputScript, types.SCRIPTHASH],
      [MultisigOutputScript, types.MULTISIG],
      [DataOutputScript, types.DATA],
      ...
      [ContractOutputScript, types.CONTRACT]
    ]) {
