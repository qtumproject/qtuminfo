...
export default class QtuminfoAPIService extends Service {
  ...
  setupRoutes(app) {
    ...
    router.get('/stats/block-interval', this.stats.blockInterval.bind(this.stats))
    ...
    router.get('/recent-txs', this.transactions.recentTransactions.bind(this.transactions))
